...
class Telegram:
    ...
    FORCE_SUB_ID = env.get('FORCE_SUB_ID', '-1001195307028')
    FORCE_SUB = env.get('FORCE_UPDATES_CHANNEL', True)
    FORCE_SUB = True if str(FORCE_SUB).lower() == "true" else False
    SLEEP_THRESHOLD = int(env.get("SLEEP_THRESHOLD", "60"))
    FILE_PIC = env.get('FILE_PIC', "https://graph.org/file/da00712a2798e4977d0fd.jpg")
    START_PIC = env.get('START_PIC', "https://graph.org/file/da00712a2798e4977d0fd.jpg")
